# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-03-25 12:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_bseats', models.CharField(max_length=4, validators=[django.core.validators.RegexValidator(message='Enter valid number of seats', regex='^\\d+$')])),
                ('total_eseats', models.CharField(max_length=4, validators=[django.core.validators.RegexValidator(message='Enter valid number of seats', regex='^\\d+$')])),
                ...
                ('num_intermediate_stops', models.CharField(default='0', max_length=2)),
                ...
                ('destinationid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='destinationid', to='air_rsv.Airport')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_bseats', models.CharField(max_length=4, validators=[django.core.validators.RegexValidator(message='Enter valid number of seats', regex='^\\d+$')])),
                ('available_eseats', models.CharField(max_length=4, validators=[django.core.validators.RegexValidator(message='Enter valid number of seats', regex='^\\d+$')])),
