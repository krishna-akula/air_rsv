# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-03-22 20:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departure_time', models.CharField(max_length=5, validators=[django.core.validators.RegexValidator(message='Enter valid time of format HH:MM 24hour', regex='^((1[0-2]|0?[1-9]):([0-5][0-9]) ([AaPp][Mm]))$')])),
                ('arrival_time', models.CharField(max_length=5, validators=[django.core.validators.RegexValidator(message='Enter valid time of format HH:MM 24hour', regex='^((1[0-2]|0?[1-9]):([0-5][0-9]) ([AaPp][Mm]))$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('offer_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='air_rsv.Offers')),
                ('passenger_email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='air_rsv.Passenger')),
            ],
        ),
        migrations.AddField(
